#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Mining & Rare Earth / Ore Grade Depletion Floor
===============================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Mining & Rare Earth (Ore Grade Depletion Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "mining_rare_earth",
    "domain_name": "Mining & Rare Earth",
    "theorem": "Ore Grade Depletion Floor",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 150.0,
    "channels": {
        "C1_environmental_degradation": {
            "dist": "lognormal",
            "low": 780.0,
            "mid": 1000.0,
            "high": 1500.0,
            "weight": 0.52,
            "description": "Radioactive tailings, acid mine drainage, deforestation, biodiversity loss, water contamination. Bayan Obo: 70km\u00b2 tailings lake. 35Mt hazardous waste/yr globally. Sources: Nuss & Eckelman 2014, Ali 2014, UNEP IRP."
        },
        "C2_labor_health": {
            "dist": "lognormal",
            "low": 45.0,
            ...
            "high": 120.0,
            "weight": 0.04,
            "description": "Silicosis, heavy-metal poisoning, artisanal mining deaths (40K/yr DRC cobalt alone), child labor 40K+. Sources: ILO, Amnesty International, Lancet."
        },
        "C3_community_fpic": {
            "dist": "lognormal",
            "low": 25.0,
            ...
            "high": 65.0,
            "weight": 0.025,
            "description": "Forced displacement (10M+ people), FPIC violations, indigenous land seizure, cultural destruction. Sources: Oxfam, First Peoples Worldwide, ICMM."
        },
        "C4_perpetual_remediation": {
            "dist": "lognormal",
            "low": 67.0,
            "mid": 130.0,
            "high": 200.0,
            "weight": 0.08,
            "description": "Post-closure liability extends centuries. 500K+ abandoned mines in US alone. Acid drainage treatment in perpetuity. Sources: EPA, ICMM, Fraser Institute."
        },
        "C5_geopolitical_concentration": {
            "dist": "lognormal",
            "low": 80.0,
            "mid": 150.0,
            "high": 250.0,
            "weight": 0.09,
            "description": "China controls 60-90% of REE processing. Supply weaponization (2010 Japan embargo). Strategic vulnerability premium. Sources: USGS, EU Critical Raw Materials Act, IEA."
        },
        "C6_governance_resource_curse": {
            "dist": "lognormal",
            "low": 150.0,
            "mid": 250.0,
            "high": 400.0,
            "weight": 0.16,
            "description": "Dutch disease, institutional erosion, conflict minerals ($185M/yr to armed groups), transparency failures. Sources: Sachs & Warner, EITI, Global Witness, OECD Due Diligence."
        }
    },
    "impossibility_floor": 4.5
}
